...
#| fig-height: 6
#| echo: false
#| dev: !expr ifelse(fromJSON(Sys.getenv("QUARTO_EXECUTE_INFO"))$format$identifier$`target-format` %in% c("pdf", "apaquarto-pdf", "latex"), "png", "svg")
...
#| label: summary_full
#| echo: false
capture.output(print(m.full))[14:74] |>
  writeLines()
```
...
When including all three factors in the model, we now see very strong evidence that confidence levels are decreased with anxious depression and increased with compulsivity. 
